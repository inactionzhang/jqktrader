...
#from pywinauto.keyboard import escape_specials
...
class ClientTrader(IClientTrader):
    ...
    def _type_edit_control_keys1(self, control_id, text):
        ...
        if not self._editor_need_type_keys:
            ...
            editor.set_focus()  # 确保输入框获得焦点
            editor.type_keys("^a{DELETE}" +text)    
